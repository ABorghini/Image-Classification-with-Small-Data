...
class ResNet(nn.Module):
    ...
    def build_classifier(cls, arch: str, num_classes: int, input_channels: int):
        ...
        elif arch == "wide_resnet50_2" or arch == "wide_resnet101_2":
        ...
        model = ResNet(
            RES_CONFIG["resnext50_32x4d"]["block"],
            RES_CONFIG["resnext50_32x4d"]["layers"],
            **kwargs
        )
        # cls_instance = cls(**c, num_classes=num_classes, input_channels=input_channels)
        return model
